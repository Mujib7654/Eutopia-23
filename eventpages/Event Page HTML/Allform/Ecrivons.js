...
async function onsubmit(){
  var Name = document.getElementById("Name").value;
    ...
    var details ={Name,Email,Whatsappnum,Institutename,standard,Guardname,Guardnum,lang,Poetry};
  ...
  const dataToSend = {
    ...
    eventId: "10fc081a-3259-42ec-823b-6970168a2bc7",
  };
...
const submitBtn = document.getElementById("ecrivons_submit");
